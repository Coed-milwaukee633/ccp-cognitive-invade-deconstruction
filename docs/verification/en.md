# Citation Fact-Checking Verification Report

This report provides a line-by-line fact-check of every citation used in *CCP Cognitive Warfare Against Taiwan: Deconstructing Structure, Technology & Operational Chains*. Errors discovered during verification have been corrected directly in the document; pre-correction versions are preserved in git history.
...
|----------|--------|---------|
| [1] King et al. (2017) | ✅ Verified | Authors, journal, page numbers, 448 million estimate all confirmed |
| [2] Google TAG (2024) | ✅ Verified | 10,000+ / 175,000+ figures confirmed |
| [3] ASPI (2020) | ✅ Verified | 8 authors and correct subtitle confirmed |
| [4] Meta / Spamouflage (2019–2023) | ✅ Verified | 7,704 accounts / 954 pages confirmed by Meta official report |
| [5] Financial Times (2019) | ✅ Verified | FT investigation exists, core content confirmed |
| [5b] Want Want China Holdings annual report | ✅ Verified | 477M RMB, NT$2.19B conversion confirmed |
| [6] Freedom House (2022) | ✅ Verified | Report exists, includes Taiwan chapter |
| [7][8][9] Espionage prosecution stats | ✅ Verified | Case counts and individual counts listed separately; source is NSB 2025 report |
| [10] Lin Te-wang / RFA (2023) | ✅ Verified | Prosecution facts confirmed |
| [11] Chang Meng-chung couple / VOA (2024) | ✅ Verified | NT$74M (≈US$2.32M) confirmed |
| [12] IORG (2020–2024) | ✅ Verified | Current name "Taiwan Information Environment Research Center" confirmed |
| [13] Doublethink Lab (2024) | ✅ Verified | 10,141 suspicious items confirmed |
...
### [1] King, G., Pan, J., & Roberts, M. E. (2017)

**Cited claim**: The Chinese government produces approximately 448 million social media posts per year.

- **Authors**: Gary King (Harvard University), Jennifer Pan (Stanford University), Margaret E. Roberts (UC San Diego)
- **Journal**: *American Political Science Review*, Vol. 111, No. 3, pp. 484–501
- **Core data**: The paper's abstract explicitly states "the government fabricates and posts about 448 million social media comments a year"
- **DOI**: `10.1017/S0003055417000144`

**Primary source**: [Cambridge Core](https://www.cambridge.org/core/journals/american-political-science-review/article/how-the-chinese-government-fabricates-social-media-posts-for-strategic-distraction-not-engaged-argument/4662DB26E2685BAF1485F14369BD137C)

---

### [2] Google Threat Analysis Group / DRAGONBRIDGE (2024)

**Cited claim**: The DRAGONBRIDGE network had over 10,000 instances disrupted in Q1 2024 alone, with 175,000+ lifetime disruptions.

- **Source**: Google TAG blog post dated June 26, 2024, authored by Zak Butler
- **10,000+ instances (Q1 2024)**: Confirmed
- **175,000+ lifetime instances**: Confirmed
- **"50+ platforms"**: This figure is attributed to Meta [4], not Google TAG

**Primary source**: [Google TAG Blog](https://blog.google/threat-analysis-group/google-disrupted-dragonbridge-activity-q1-2024/)

---

### [3] ASPI *Retweeting through the Great Firewall* (2020)

**Cited claim**: ASPI 2020 report corroborated cross-national operational patterns of the internet commentator system.

- **Authors**: Wallis, J., Uren, T., Thomas, E., Zhang, A., Hoffman, S., Li, L., Pascoe, A., & Cave, D. (8 authors)
- **Title**: *Retweeting through the Great Firewall: A persistent and undeterred threat actor*
- **Publisher**: ASPI International Cyber Policy Centre, June 2020

**Primary source**: [ASPI](https://www.aspi.org.au/report/retweeting-through-great-firewall/)

---

### [4] Meta / Spamouflage CIB Reports (2019–2023)

**Cited claim**: Meta exposed the Spamouflage network involving 7,704 accounts and 954 pages, active across 50+ platforms.

- **7,704 accounts / 954 pages**: From Meta Q2 2023 Adversarial Threat Report. Also included 15 groups and 15 Instagram accounts
- **"Largest" description**: Meta's official language was "the largest known cross-platform covert influence operation in the world"
- **50+ platforms**: From Meta's August 2023 report (cited by Ben Nimmo)

**Primary source**: [Meta Announcement](https://about.fb.com/news/2023/08/raising-online-defenses/); [Meta Transparency Report](https://transparency.meta.com/integrity-reports-q2-2023/)

---

### [5] Hille, K. / Financial Times (2019) — Want Want Group

**Cited claim**: Financial Times investigation revealed China Times editorial operations were influenced by the TAO.

- **Author**: Kathrin Hille, FT's Greater China correspondent
- **Title**: "Taiwan primaries highlight fears over China's political influence," July 16, 2019
- **Content**: FT report was based on anonymous journalists alleging that TAO made "daily calls" influencing cross-strait coverage topics and angles. Want Want Group denied the allegations and filed (later dismissed) defamation suits

**Primary source**: [FT](https://www.ft.com/content/036b609a-a768-11e9-984c-fac8325aaa04); [RSF](https://rsf.org/en/taiwan-abusive-libel-suit-against-financial-times-correspondent)

---

### [5b] Want Want China Holdings Annual Report — Government Subsidies

**Cited claim**: Want Want Group received approximately 477 million RMB in government subsidies during 2017–2018.

- **Amount**: 477 million RMB from Want Want China Holdings' 2017/2018 fiscal year HKEX annual reports under "Other Income — Government Grants"
- **NT$ conversion**: Approximately NT$2.19 billion
- **Source**: Independent reporting by Taiwanese media (PTS, Taiwan News) in April 2019 based on HKEX annual reports

**Primary source**: [PTS](https://news.pts.org.tw/article/429749); [Taiwan News](https://www.taiwannews.com.tw/news/3686238)

---

### [6] Freedom House (2022) — Beijing's Global Media Influence

**Cited claim**: Taiwan chapter documented Chinese capital penetrating Taiwan's media ecosystem through multiple channels.

- **Full title**: *Beijing's Global Media Influence 2022: Authoritarian Expansion and the Power of Democratic Resilience*, September 8, 2022
- **Taiwan chapter**: One of 30 country reports, authored by Angeli Datt
- **Content**: Covers paid advertising, content partnerships, indirect investment (Cher Wang's TVBS case, Tsai Eng-meng's Want Want Group)

**Primary source**: [Freedom House](https://freedomhouse.org/country/taiwan/beijings-global-media-influence/2022)

---

### [7][8][9] Taiwan Espionage Prosecution Statistics

**Cited claim**: Espionage prosecutions have surged dramatically in recent years, with approximately two-thirds involving military personnel.

- **Source**: Taiwan's National Security Bureau report, January 12, 2025
- **Case counts**: 2021: 3 → 2022: 5 → 2023: 14 → 2024: 15
- **Individuals prosecuted**: 2021: 16 → 2022: 10 → 2023: 48 → 2024: 64
- **Military ratio**: Of 64 individuals in 2024: 28 active-duty + 15 retired = 43 (approximately 67%)

**Primary sources**: [Taipei Times](https://www.taipeitimes.com/News/front/archives/2025/01/13/2003830100); [Jamestown Foundation](https://jamestown.org/program/taiwan-exposes-more-prc-military-infiltration-cases/); [CEIAS](https://ceias.eu/a-threat-from-within-chinese-espionage-in-taiwan/); [CNN](https://edition.cnn.com/2025/01/13/china/taiwan-surge-suspected-chinese-espionage-hnk-intl)

---

### [10] Lin Te-wang / RFA (2023)

**Cited claim**: In October 2023, Taiwan People's Communist Party founder Lin Te-wang was indicted for violating the Anti-Infiltration Act.

- **Date**: Taipei District Prosecutors' Office filed charges on October 3, 2023
- **Legal basis**: Anti-Infiltration Act and Civil Servants Election and Recall Act
- **TAO connection**: Prosecutors alleged Lin had over a decade of contact with TAO Political Parties Bureau official Hu Chunguang
- **Note**: On June 9, 2025, the Taipei District Court ruled not guilty

**Primary source**: [RFA](https://www.rfa.org/english/news/china/taiwan-communist-infiltration-10042023041825.html); [Focus Taiwan](https://focustaiwan.tw/politics/202310030029)

---

### [11] Chang Meng-chung & Hung Wen-ting / VOA (2024)

**Cited claim**: In 2024, the couple Chang Meng-chung and Hung Wen-ting were indicted for accepting funding for media propaganda activities.

- **Date**: Chiayi District Prosecutors' Office filed charges on November 4, 2024
- **Persons**: Chang Meng-chung and his wife Hung Wen-ting, members of the China Unification Promotion Party
- **Amount**: NT$74 million (approximately US$2.32 million), from 2011 to 2023
- **Activities**: Producing current affairs commentary programs for YouTube, Facebook, Douyin, and radio

**Primary source**: [VOA](https://www.voanews.com/a/taiwanese-couple-prosecuted-for-spreading-china-s-propaganda/7853843.html); [Taipei Times](https://www.taipeitimes.com/News/front/archives/2024/11/05/2003826395)

---

### [12] IORG (2020–2024)

**Cited claim**: IORG has systematically tracked Chinese information manipulation since 2019.

- **Current name**: Taiwan Information Environment Research Center
- **Founded**: 2019
- **Kansai Airport case**: Case Study B.1, during Typhoon Jebi in September 2018 — IORG's first documented case of Chinese information manipulation targeting Taiwan

**Primary source**: [IORG](https://iorg.tw/_en/about); [Research Reports](https://iorg.tw/_en/r/b)

---

### [13] Doublethink Lab (2024)

**Cited claim**: Doublethink Lab detected over 10,000 suspicious information items.

- **Precise figure**: 10,141 items recorded as of January 13, 2024
- **Monitoring period**: October 1, 2023 to January 31, 2024
- **Report title**: "2024 Taiwan Elections: Foreign Influence Observation — Preliminary Statement"

**Primary source**: [Doublethink Lab](https://medium.com/doublethinklab/2024-taiwan-elections-foreign-influence-observation-preliminary-statement-caeeccb5b88e)

---

### [14] Election Interference Statistics

**Cited claim**: The Ministry of Justice reported 77 suspected interference cases with 157 individuals investigated.

- **Data source**: Deputy Minister of Justice Huang Mou-hsin, press conference on December 28, 2023
- **Initial figures**: 77 cases / 157 individuals (late December 2023)
- **Updated figures**: By January 11, 2024 (pre-election), Supreme Prosecutors' Office reported 117 cases / 287 individuals

**Primary source**: [Taipei Times](https://www.taipeitimes.com/News/front/archives/2023/12/29/2003811309); [Brookings](https://www.brookings.edu/articles/what-lessons-can-taiwan-share-with-the-world-on-election-interference/)

---

### [15] Brookings Institution (2024)

**Cited claim**: Lessons from the 2024 Taiwan election on countering foreign interference.

- **Author**: Yang Kuang-shun, co-founder of US-Taiwan Watch and IORG researcher
- **Title**: "What lessons can Taiwan share with the world on election interference?", June 11, 2024

**Primary source**: [Brookings](https://www.brookings.edu/articles/what-lessons-can-taiwan-share-with-the-world-on-election-interference/)

---

### [16] Stanford Internet Observatory / *Telling China's Story* (2020)

**Cited claim**: Systematic analysis of China's full-spectrum information operations framework.

- **Authors**: DiResta, R., Miller, C., Molter, V., Pomfret, J., & Tiffert, G. (5 authors)
- **Title**: *Telling China's Story: The Chinese Communist Party's Campaign to Shape Global Narratives*
...
2. **Source hierarchy**: Primary sources (academic papers, official reports, platform announcements) were prioritized, with reliable news reporting used as secondary verification.
3. **Correction handling**: Errors discovered during verification were corrected directly in the document. Pre-correction versions are preserved in git history.
4. **Limitations**: Some paywalled articles (e.g., FT) were cross-verified through secondary reporting.
